...
\documentclass{article}
  ...
  \begin{document}
    ...
    \section{c3 Ciphertext}
      ...
      A boon to the breaking of the substitution cipher was Simon Singh's page on cracking the substitution cipher
      and likely trigrams and digrams to occur within the English language.
